...
class CatQuality extends StatefulWidget {
  const CatQuality({super.key});

  @override
  State<CatQuality> createState() => _CatQualityState();
}

class _CatQualityState extends State<CatQuality> {
  ...
  void fetchPosts() async {
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('updates')
          .where("category", isEqualTo: "Quality")
          .get();
