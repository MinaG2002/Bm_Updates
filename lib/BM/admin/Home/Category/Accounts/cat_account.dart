...
class CatAccount extends StatefulWidget {
  const CatAccount({super.key});

  @override
  State<CatAccount> createState() => _CatAccountState();
}

class _CatAccountState extends State<CatAccount> {
  ...
  void fetchPosts() async {
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('updates')
          .where("category", isEqualTo: "Accounts & Certificates")
          .get();
